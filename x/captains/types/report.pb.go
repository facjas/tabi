...
const (
	...
	ReportType_REPORT_TYPE_EMISSION ReportType = 4
)
...
type NodeEpochEmission struct {
	...
	NodeEmission github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,2,opt,name=node_emission,json=nodeEmission,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"node_emission"`
}
...
var fileDescriptor_2b04da73fb1305c0 = []byte{
	...
	,
}
...
func (m *NodeEpochEmission) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size := m.NodeEmission.Size()
		i -= size
		if _, err := m.NodeEmission.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintReport(dAtA, i, uint64(size))
	}
